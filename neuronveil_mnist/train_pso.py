...
def train_mnist_model() -> Model:
    ...
    optimiser = ps.single.GlobalBestPSO(n_particles=1000, dimensions=dimensions,
                                        options=options, bounds=bounds)

    cost, parameters = optimiser.optimize(batch_objective, iters=1000) # TODO change to 500
